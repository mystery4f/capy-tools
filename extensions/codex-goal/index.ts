/**
 * Bundled into Capy Tools from pi-codex-goal v0.1.10 (MIT).
...
import { budgetLimitPrompt, continuationGoalIdFromPrompt, continuationPrompt } from "./prompts.ts";
import { applyUsage, clearEntry, goalWithLiveUsage, reconstructGoal, setEntry, updateGoalStatus } from "./state.ts";
